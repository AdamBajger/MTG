...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        TapForManaAbility tapForMana = new BasicTapForManaAbility(island, new ManaSet(), new ManaSet(new HashSet<>(Arrays.asList(new BasicMana(island, Color.RED), new BasicMana(island, Color.BLUE)))));
        ...
        //---------------------------------------
        TapForManaAbility expensiveTapForMana = new BasicTapForManaAbility(island,
